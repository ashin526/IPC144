...
//Function 1: Ensures that integer values are entered and returned.
int getInteger(void){
	int getInt = 0;
	char nl = 0;
	do{
...
// Function 2: Ensures that a positive interger values are entered and returned.
...
//Function 3: Ensures that a double values are entered and returned.
...
//Function 4: Ensures that a positive double values are entered and returned.
...
//Function 5: Ensures that a positive double values are entered and returned.
...
//Function 6: Ensures that an integer value is entered within the range (inclusive) and returned.
...
// Function 7: Ensures that a single character value is entered and returned within a valid character list (defined by the received C string argument).
...
// Function 8: Ensure that C string values containing the number of characters within the specified range as the second and third arguments are entered (and returned through the first argument pointer).
