...
void displayAccount(const struct Account account, const struct Person person, const struct UserLogin login);
...
int main(void)
{
    ...
    person.birth = getIntFromRange(currentYear() - 110, currentYear() - 18);
    printf("Enter the household Income: $");
    person.income = getPositiveDouble2();
    ...
    // ---------------------------------------------------------
    displayAccount(account, person, login);
...
void displayAccount(const struct Account account, const struct Person person, const struct UserLogin login)
{
    ...
    printf("%05d %-9s %-15s %5d %11.2lf %-10s %-10s %8s\n", account.account_no, accounttype, person.fullname, person.birth, person.income, person.country, login.login, login.password);
}
