...
// Ensures that a single character value is entered and returned within a valid character list.
...
// Ensures that character value is entered and returned within a valid character list.
